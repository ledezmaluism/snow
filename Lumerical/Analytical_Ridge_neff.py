...
# wl = 1
# n0 = 1
# ne = lumpy.refractive_index('LN_MgO_e', wl)
# no = lumpy.refractive_index('LN_MgO_o', wl)
# d = 0.45
# print('TE neff = ', neff_symmetric_slab(n0,ne,d,wl))
# print('TM neff = ', neff_symmetric_slab(n0,no,d,wl,mode='TM even'))


# =============================================================================
# Testing -Asymmetrical
# =============================================================================
# wl = 1
# d = 0.45
# n0 = 1
...
# print('TE = ', neff_asymmetric_slab(n0, n1, n2, d, wl, 'TE'))
# print('TM = ', neff_asymmetric_slab(n0, n1, n2, d, wl, 'TM'))
# print('TE = ', neff_asymmetric_slab(n0, n1, n2, d, wl, 'TE', order=1))
# print('TM = ', neff_asymmetric_slab(n0, n1, n2, d, wl, 'TM', order=1))

# =============================================================================
# Single mode operation:
# Vertical confinement
# =============================================================================
# wl = np.arange(0.5, 2.2, 0.01)

# #Stackup
# n0 = 1
# n = lumpy.refractive_index('LN_MgO_e', wl)
# n2 = lumpy.refractive_index('SiO2', wl)


# h_ridge = singlemode_asymmetric(n0, n, n2, wl)
# plt.plot(wl, h_ridge)
# plt.grid('True')
# plt.xlabel('Wavelength (um)')
# plt.ylabel('Max Thin-Film Thickness (um)')
...
# #Horizontal step
# neff_te0 = neff_symmetric_slab(neff_slab_te0, neff_ridge_te0, width, wl, 'TM even')
